...
public class InstrumentView extends View {
    ...
    private void drawFigure(Canvas canvas, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.drawText(figure+"时",pointFromAngleAndRadius[0],pointFromAngleAndRadius[1],mPaint);
            canvas.restore();
        }
    }
...
//        canvas.drawText("当前进度："+progress+"%",);
        ...
        double d = progress;
        canvas.drawText(d/10 + "时", centerPoint[0], baseLine1, mPaint);
